...
- [Infinity.Run Portable (.exe) - 8.5 MB](https://github.com/yashcode4/Infinity.Run/releases/download/v1.4.0/InfinityDotRun_Portable.exe)  
  Just download and play – no installation needed.

- [Infinity.Run MSI Installer (.msi) - 3.2 MB](https://github.com/yashcode4/Infinity.Run/releases/download/v1.4.0/InfinityDotRun_Installer_MSI.msi)  
  Standard Windows installer – recommended.

- [Infinity.Run NSIS Installer (.exe) - 2.3 MB](https://github.com/yashcode4/Infinity.Run/releases/download/v1.4.0/InfinityDotRun_Installer_NSIS.exe)  
